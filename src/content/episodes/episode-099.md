---
title: "Back to the Basics — Web Fundamental to 100k a Year in Bug Bounty"
episode: 99
---
...
**Guest:** Roni (0xLupin)
**Duration:** 1:42:54
**Transcript source:** feed (show notes only)

### Summary
This episode covers Justin's old Twitter thread about how to start bug bounty with the goal of making $100K in the first year. Topics include web fundamentals education, threat modeling, hacking goals, vulnerability types, and finding specialization.

Note: This episode has show notes only (no full transcript). Details are limited to the description and timestamps: Introduction, Web Fundamentals Education, Threat Modeling and Hacking Goals, Vuln Types and Finding Specialization.
---

### 📘 Episode Booklet

#### 1. Episode in one sentence
Episode Episode 99 Back to the Basics — Web Fundamental to 100k a Year in Bug Bounty covers practical bug bounty techniques and security research insights.
