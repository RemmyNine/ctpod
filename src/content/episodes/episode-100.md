---
title: "8 Fav Bugs of 2024, Farewell Joel, Hello Shift"
episode: 100
---


# Episode 100 8 Fav Bugs of 2024, Farewell Joel, Hello Shift

**Host:** Justin Gardner (Rhynorater)
**Former Co-Host:** Joel Margolis (farewell episode)
**Duration:** 1:41:40
**Transcript source:** feed (show notes only)

### Summary
- Celebration of 100 episodes
- Joel Margolis leaves the show as co-host (returns as guest)
- Multiple hackers share their "best bug of the year": Nagli, Shubs, Matt Brown, MatanBer, Douglas Day, Alex Chapman, Nahamsec, Rez0
- Shift announcement (AI-powered Caido plugin)

Note: Show notes only. Guest bugs from: Nagli, Shubs, Matt Brown, MatanBer, Douglas Day, Alex Chapman, Nahamsec, Rez0.

### Tools and Resources
- Delorean (github.com/jselvi/Delorean)
...
Episode Episode 100 8 Fav Bugs of 2024, Farewell Joel, Hello Shift covers practical bug bounty techniques and security research insights.
